...
namespace CMI.Processor
{
    public class OutboundFieldVisitProcessor: OutboundBaseProcessor
    {
        ...
        public override TaskExecutionStatus Execute(IEnumerable<MessageBodyResponse> messages)
        {
            ...
            TaskExecutionStatus taskExecutionStatus = new TaskExecutionStatus { TaskName = "Process Field Visit Activity", IsSuccessful = true, NexusReceivedMessageCount = messages.Count() };
